...
import com.pip.chatbot.jooq.finance.tables.records.SymbolRecord;
...
public class Symbol extends TableImpl<SymbolRecord> {
    ...
    private static final long serialVersionUID = -818999143;

    /**
     * The reference instance of <code>finance.symbol</code>
     */
    ...
    /**
     * The column <code>finance.symbol.symbol</code>.
     */
    ...
    /**
     * The column <code>finance.symbol.full_name</code>.
     */
    public final TableField<SymbolRecord, String> FULL_NAME = createField(DSL.name("full_name"), org.jooq.impl.SQLDataType.VARCHAR(127).nullable(false), this, "");

    /**
     * The column <code>finance.symbol.is_currency</code>.
     */
    ...
    /**
     * Create a <code>finance.symbol</code> table reference
     */
    public Symbol() {
    ...
    /**
     * Create an aliased <code>finance.symbol</code> table reference
     */
    ...
    public List<UniqueKey<SymbolRecord>> getKeys() {
        return Arrays.<UniqueKey<SymbolRecord>>asList(Keys.SYMBOL_PKEY);
    }
