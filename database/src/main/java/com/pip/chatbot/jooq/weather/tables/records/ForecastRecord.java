...
public class ForecastRecord extends UpdatableRecordImpl<ForecastRecord> implements Record11<Integer, LocalDateTime, LocalDateTime, Float, Float, Float, Float, Float, String, String, String> {
    ...
    private static final long serialVersionUID = -1448807657;
     ...
     */
    public ForecastRecord(Integer id, LocalDateTime createdOn, LocalDateTime date, Float temperature, Float perceivedTemperature, Float windSpeed, Float pressure, Float humidity, String summary, String city, String icon) {
        super(Forecast.FORECAST);
