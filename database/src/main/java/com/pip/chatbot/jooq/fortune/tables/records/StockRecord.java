...
public class StockRecord extends UpdatableRecordImpl<StockRecord> implements Record5<Long, String, Float, LocalDate, Boolean> {

    private static final long serialVersionUID = -288591148;
    ...
    @Override
    public Row5<Long, String, Float, LocalDate, Boolean> valuesRow() {
    ...
    @Override
    public StockRecord value4(LocalDate value) {
        setDate(value);
        return this;
    }
    ...
    @Override
    public StockRecord values(Long value1, String value2, Float value3, LocalDate value4, Boolean value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public StockRecord(Long id, String symbol, Float value, LocalDate date, Boolean isHistorical) {
        super(Stock.STOCK);
